...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("BotsXSupport")
                await self.one.join_chat("BotsXSupport")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("BotsXSupport")
                await self.two.join_chat("BotsXSupport")
            except:
                pass
            assistants.append(2)
            ...
            try:
                await self.two.send_message(
                    config.LOG_GROUP_ID, f"**» Assistant Stated"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("BotsXSupport")
                await self.three.join_chat("BotsXSupport")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("BotsXSupport")
                await self.four.join_chat("BotsXSupport")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("BotsXSupport")
                await self.five.join_chat("BotsXSupport")
            except:
                pass
            assistants.append(5)
